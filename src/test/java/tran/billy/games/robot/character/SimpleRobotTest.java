...
import tran.billy.games.robot.sufaces.RectTable;
...
class SimpleRobotTest {
    ...
    void place() {
        ...
        Assertions.assertFalse((new SimpleRobot(null)).place(new Position(3,4), Direction.findByName("NORTH")), "Robot should NOT be placed on an invalid surface");
    }
    ...
    void turnLeft() {
        ...
        Assertions.assertNull((new SimpleRobot(null).turnLeft()),"Robot must be placed on a surface before being able to turn left");
    }
    ...
    void turnRight() {
        ...
        Assertions.assertNull((new SimpleRobot(null).turnRight()),"Robot must be placed on a surface before being able to turn right");
    }
